...
def ResNet18(num_classes=2, channels=3):
    return ResNet([2, 2, 2, 2], num_classes, channels)

@register_model('resnet34')
def ResNet50(num_classes=2, channels=3):
    return ResNet([3, 4, 6, 3], num_classes, channels)

@register_model('resnet50')
def ResNet101(num_classes=2, channels=3):
    return ResNet([3, 4, 23, 3], num_classes, channels)

@register_model('resnet101')
def ResNet152(num_classes=2, channels=3):
    return ResNet([3, 8, 36, 3], num_classes, channels)
